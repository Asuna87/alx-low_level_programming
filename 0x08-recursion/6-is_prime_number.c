...
* Description: This function uses recursion to determine if `n` is a prime number.
*/
int is_prime_helper(int n, int divisor)
{
/* Base cases: if divisor exceeds half of n, or n is divisible by divisor, return appropriate values */
if (divisor > n / 2) {
return (1); /* n is prime */
}
if (n % divisor == 0) {
...
return (is_prime_helper(n, 2)); /* Start checking divisibility from divisor 2 */
}
